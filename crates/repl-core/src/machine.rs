...
impl Machine {
    ...
    pub fn completed(&mut self, completion: Completion) {
        match completion {
            ...
            Completion::ResumeSent => self.paused = false,
...
mod tests {
    ...
    fn final_step_uses_the_minimum_gap() {
        ...
        m.observe(&view(11, 59, true)); // remaining = 1
    ...
    fn untrustworthy_samples_are_dropped_entirely() {
        ...
        // 整定器会误加间隔，最终导致跨帧。
        let mut blocked = view(11, 55, true);
